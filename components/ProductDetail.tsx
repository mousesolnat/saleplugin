...
import { 
  ...
  AlertTriangle, Star, Share2, Facebook, Twitter, Linkedin
} from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-8 lg:p-12">
            ...
            {/* Add to Cart */}
            <div className="flex gap-4 mb-8 border-b border-slate-100 pb-8">
              <div className="flex-1">
                <button
                  onClick={handleAdd}
                  disabled={isAdded}
                  className={`w-full py-4 px-6 rounded-xl flex items-center justify-center gap-2 font-bold text-lg transition-all duration-200 transform ${
                    isAdded
